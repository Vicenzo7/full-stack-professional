...
public abstract class AbstractTestContainers {
    ...
    protected static final PostgreSQLContainer<?> postgreSQLContainer =
            new PostgreSQLContainer<>("postgres:latest")
                    .withDatabaseName("vicenzo-dao-unit-test")
                    .withUsername("root")
                    .withPassword("root");

    // below function will change(virtual-> in the program) the spring datasource properties in application.yml file dynamically
